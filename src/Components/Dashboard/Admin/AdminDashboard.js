      ...
      .then((querySnapshot) => {
        ...
        firestoreData.map((item) => {
          ...
          const destructureData = {
            ...
            lowerBudget: itemData.lowerBudget,
            upperBudget: itemData.upperBudget,
      ...
      <div className="container-fluid">
        ...
        <div className="row">
          ...
          <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            {selectedMenu === "ALLPOST" && (
              <AllJobPosts jobPosts={jobPosts} setIsUpdated={setIsUpdated} />
            )}
